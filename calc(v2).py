...
checkbut_2_1 = Checkbutton(window,text='骑士(450)',font=('黑体',14),variable=checkvar_2_1,onvalue=1,offvalue=0).place(x=15,y=220)
checkbut_2_2 = Checkbutton(window,text='水月(300)',font=('黑体',14),variable=checkvar_2_2,onvalue=1,offvalue=0).place(x=15,y=255)
checkbut_2_3 = Checkbutton(window,text='锈锤(120)',font=('黑体',14),variable=checkvar_2_3,onvalue=1,offvalue=0).place(x=15,y=290)
checkbut_2_4 = Checkbutton(window,text='寒灾(150)',font=('黑体',14),variable=checkvar_2_4,onvalue=1,offvalue=0).place(x=15,y=325)
checkbut_2_5 = Checkbutton(window,text='墓碑(230)',font=('黑体',14),variable=checkvar_2_5,onvalue=1,offvalue=0).place(x=15,y=360)
...
scale_5_1 = Scale(window, from_=0, to=8, orient=tk.HORIZONTAL, length=200, showvalue=0,tickinterval=1, resolution=1, command=com_result_5_1).place(x=70,y=443)
...
scale_5_2 = Scale(window, from_=0, to=8, orient=tk.HORIZONTAL, length=200, showvalue=0,tickinterval=1, resolution=1, command=com_result_5_2).place(x=70,y=493)
...
scale_5_3 = Scale(window, from_=0, to=8, orient=tk.HORIZONTAL, length=200, showvalue=0,tickinterval=1, resolution=1, command=com_result_5_3).place(x=70,y=543)
...
title_7 = tk.Label(window,text='修正分(上场分数或超出计算器部分分数)',font=('黑体',15)).place(x=600,y=480)
...
title_0 = tk.Label(window,text='总分',font=('黑体',30)).place(x=980,y=5)
result_0 = Entry(window,bd=0,width=10,font=('黑体',24),textvariable=text_v_result_0,state='readonly',relief='sunken')
result_0.place(x=1080,y=12)



title_2 = tk.Label(window,text='结局',font=('黑体',15)).place(x=1000,y=70)
result_2 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_2,state='readonly',relief='sunken').place(x=1050,y=73)
result_0_2 = Entry(window,bd=0,width=200,font=('黑体',14),textvariable=text_v_result_0_2,state='readonly',relief='sunken').place(x=1100,y=73)

title_4 = tk.Label(window,text='藏品',font=('黑体',15)).place(x=1000,y=110)
result_4 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_4,state='readonly',relief='sunken').place(x=1050,y=113)

title_1 = tk.Label(window,text='临招',font=('黑体',15)).place(x=1150,y=110)
result_1 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_1,state='readonly',relief='sunken').place(x=1200,y=113)
result_0_1 = Entry(window,bd=0,width=200,font=('黑体',14),textvariable=text_v_result_0_1,state='readonly',relief='sunken').place(x=1250,y=113)

title_8 = tk.Label(window,text='结算',font=('黑体',15)).place(x=1000,y=150)
result_8 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_8,state='readonly',relief='sunken').place(x=1050,y=153)

title_6 = tk.Label(window,text='启示',font=('黑体',15)).place(x=1000,y=190)
result_6 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_6,state='readonly',relief='sunken').place(x=1050,y=193)

title_5 = tk.Label(window,text='隐藏',font=('黑体',15)).place(x=1000,y=230)
result_5 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_5,state='readonly',relief='sunken').place(x=1050,y=233)
result_0_5 = Entry(window,bd=0,width=200,font=('黑体',14),textvariable=text_v_result_0_5,state='readonly',relief='sunken').place(x=1100,y=233)

title_3 = tk.Label(window,text='紧急',font=('黑体',15)).place(x=1000,y=270)
result_3 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_31,state='readonly',relief='sunken').place(x=1050,y=273)
result_0_31 = Entry(window,bd=0,width=200,font=('黑体',10),textvariable=text_v_result_0_31,state='readonly',relief='sunken').place(x=1010,y=313)

title_32 = tk.Label(window,text='事件',font=('黑体',15)).place(x=1000,y=350)
result_32 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_32,state='readonly',relief='sunken').place(x=1050,y=353)
result_0_32 = Entry(window,bd=0,width=200,font=('黑体',10),textvariable=text_v_result_0_32,state='readonly',relief='sunken').place(x=1010,y=393)

title_7 = tk.Label(window,text='修正',font=('黑体',15)).place(x=1000,y=430)
result_7 = Entry(window,bd=0,width=10,font=('黑体',14),textvariable=text_v_result_7,state='readonly',relief='sunken').place(x=1050,y=433)
...
but_shut = Button(window, text = '  关闭  ',font = ('黑体',40),command = shut)
but_shut.place(x=1126,y=507)
...
but_clear = Button(window, text = '  归零  ',font = ('黑体',40),command = restart)
but_clear.place(x=1383,y=507)
